...
const Step3Report = ({ report }) => {
    ...
    const downloadPDF = () => {
        ...
        doc.text(
            `Final Score: ${Math.round(finalScore)}/10`,
            pageWidth / 2,
            currentY + 12,
            { align: "center" }
        );
        ...
        doc.text(
            `Communication: ${Math.round(communication)}/10`,
            margin + 10,
            currentY + 18
        );
        doc.text(
            `Correctness: ${Math.round(correctness)}/10`,
            margin + 10,
            currentY + 26
        );
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8">
            <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div className="md:mb-10 w-full flex items-start gap-4 flex-wrap">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 mt-2">
                            Ai-Powered Performance Insights and Personalized Feedback
                        </p>
                    </div>
                </div>
                ...
                <button
                    onClick={downloadPDF}
                 className="bg-emerald-600 hover:bg-emerald-700 text-white py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap p-1.5" 
                >
                    Download PDF
                </button>
