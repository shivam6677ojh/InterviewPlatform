...
import evalImg from "../assets/MM.png";
                    ...
                    <div className="text-center mb-28">
                        ...
                        >
                            ...
                            <span className="relative inline-block">
                                <span className="bg-green-100 text-green-600 rounded-full px-3 py-1">
                                    AI Intelligence
                                </span>
                            </span>
                        ...
                        <div className="flex flex-wrap justify-center gap-4 mt-10">
                            ...
                            <motion.button
                                ...
                                whileHover={{ opacity: 0.9, scale: 1.03 }}
                                whileTap={{ opacity: 1, scale: 0.98 }}
                                className="border border-gray-800 px-10 py-3 rounded-full hover:bg-gray-100 transition"
                            >
                                View History
                            </motion.button>
                        </div>
                        ...
                        <div className='grid md:grid-cols-2 gap-10'>
                            {
                                [
                                    ...
                                    <motion.div
                                        ...
                                        transition={{ duration: 0.5, delay: index * 0.1 }}
                                        whileHover={{ y: -6 }}
                                        className="bg-white border border-gray-300 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all"
                                    >
